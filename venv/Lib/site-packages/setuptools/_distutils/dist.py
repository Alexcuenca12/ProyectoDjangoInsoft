...
class Distribution:
    """The P_persona of the Distutils.  Most of the work hiding behind 'setup'
    ...
    See the code for 'setup()', in P_persona.py, for details.
    """
...
"""
    ...
    def parse_command_line(self):
        ...
        -- see 'setup()' in P_persona.py).  This list is first processed for
